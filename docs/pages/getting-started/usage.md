...
If you are installing from the CDN, you can [download a local copy](https://cdn.jsdelivr.net/npm/@teamshares/shoelace/dist/web-types.json) and add it to the root of your project. Be sure to add a reference to the `web-types.json` file in your `package.json` in order for your editor to properly detect it.
