...
/**
 * @summary Segmented controls (`sl-radio-button` in Shoelace) allow the user to select a single option from a group of related options and immediately apply that selection.
